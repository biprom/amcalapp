package com.biprom.bram.amcalapp.ui.navigation;

import com.biprom.bram.amcalapp.data.Role;
import com.biprom.bram.amcalapp.security.SecurityUtils;
import com.biprom.bram.amcalapp.views.AtelierView;
...
public class NavigationManager extends SpringNavigator {
	...
	public void navigateTo(Class<? extends View> targetView, String amNummer, String opdrachtgever) {
		String viewId = getViewId(targetView);
